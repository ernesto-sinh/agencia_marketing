    ...
    return(
      <main>
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-full sm:pt-36 sm:pb-40 xl:mx-12 xl:pt-32 xl:pb-40 lg:pt-40 lg:pb-40 pt-24 pb-12">
            <div>
              <div>
                <h1 className="text-4xl font-semibold tracking-tight pb-8  sm:text-7xl">
                  About Us
                </h1>
                <p className="mt-6 text-2xl max-w-5xl leading-10 text-black ">
